...
const styles = StyleSheet.create({
  ...
  modoRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginBottom: 8 },
  chip: {
    borderWidth: 1.5,
    borderRadius: 8,
    paddingVertical: 8,
  ...
  linkNuevoText: { fontSize: 15, fontWeight: '700' },
  resumen: {
    borderWidth: 1.5,
    borderRadius: 10,
    padding: 12,
  ...
  resumenLabel: { fontSize: 12, fontWeight: '600', marginBottom: 3 },
  resumenVal: { fontSize: 14, fontWeight: '600' },
  quitar: { marginTop: 8, alignSelf: 'flex-start' },
  quitarText: { fontSize: 14, fontWeight: '700' },
});
